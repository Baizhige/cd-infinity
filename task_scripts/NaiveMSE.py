    ...
    for epoch in range(n_epoch):
        ...
        for i in range(len_dataloader):
            ...
            if len(s_label) == len(t_label):
                mse_loss0 = F.mse_loss(__s_feature0__, __t_feature0__)
                mse_loss1 = F.mse_loss(__s_feature1__, __t_feature1__)
                mse_loss2 = F.mse_loss(__s_feature2__, __t_feature2__)
                final_loss = err_s_label + mse_loss0 + mse_loss1 + mse_loss2
            else:
...
append_results_to_csv(cache_prefix, record_val_metric, record_test_metric, file_path=os.path.join("../record", "comparison_study_NaiveMSE.csv"))
