...
from my_utils.model_EEG_Infinity003Wass_woFFB_any_backbone import EEG_Infinity
...
import argparse
# ====
# As request by reviewer, I made this script for ablation study, w.o. SFB and FFB.
...
append_results_to_csv(cache_prefix, record_val_metric, record_test_metric, file_path=os.path.join("../record", "comparison_study_EEGInfinity005Wass_wo_FFB2.csv"))
