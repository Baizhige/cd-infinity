...
class EEG_Infinity(nn.Module):
    ...
    def __init__(self, transfer_matrix_source, transfer_matrix_target, num_channels = 64, FIR_order=17, FIR_n=1,
        ...
        self.class_classifier1.add_module('c_fc1', nn.Linear(self.feature_map_size, 128))
        self.class_classifier1.add_module('c_bn1', nn.BatchNorm1d(128))
        self.class_classifier1.add_module('c_relu1', nn.ReLU(True))
        self.class_classifier1.add_module('c_drop1', nn.Dropout())

        self.class_classifier2 = nn.Sequential()
        self.class_classifier2.add_module('c_fc2', nn.Linear(128, 64))
        self.class_classifier2.add_module('c_bn2', nn.BatchNorm1d(64))
        self.class_classifier2.add_module('c_relu2', nn.ReLU(True))

        self.class_classifier3 = nn.Sequential()
        self.class_classifier3.add_module('c_fc3', nn.Linear(64, self.num_classes))
    ...
    def forward(self, input_data, domain, alpha):
        ...
        __feature0__ = self.feature(filter_output).view(-1, self.feature_map_size)
        __feature1__ = self.class_classifier1(__feature0__)
        __feature2__ = self.class_classifier2(__feature1__)
        class_output = self.class_classifier3(__feature2__)

        return class_output, __feature0__, __feature1__, __feature2__
